...
public class DataBoardDAO {
	// 연결 객체 => Socket
		...
		// URL
		private final String URL="jdbc:oracle:thin:@localhost:1521:XE"; // localhost
		// singleton
		...
		public List<DataBoardVO> databoardListData(int page)
		{
			...
			try
			{
				...
				// Top-N (rownum은 중간부터 잘라올 수 없다)
				ps=conn.prepareStatement(sql); // sql문장 전송 prepareStatement => ?있는상태에서 미리 보내고 나중에 값 채우기
				// ?에 값을 채운다 맨 앞서부터 1번 2번 ...
				int rowSize=10; // 한 페이지에 10개씩
