	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cList!=null && cList.size()>0)
		{
			...
			for(FoodVO vo:cList)
			{
				...
				out.println("<a href=\"MainServlet?mod=3&fno="+vo.getFno()+"\">");
				out.println("<img src=\""+vo.getPoster()+"\" style=\"width:230px; height:200px;\"></a>"); //0000000000 MainServlet -> FLSear
				out.println("<div class=\"caption\">");
				out.println("<p style=\"font-size:9px\">"+vo.getName()+"</p>");
				out.println("<p><a href=\"FoodCookieDelServlet?mode=2&cno="+vo.getCno()+"&fno="+vo.getFno()+"\" class=\"btn btb-xs btn-warning\">삭제</a>");
				out.println("</div>");
