...
public class FoodSearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 사용자 요청값을 받는다
		request.setCharacterEncoding("UTF-8"); // 이거 안하면 한글이 깨짐
		...
		//	 --- 		 ---
		//   startPage	endPage
		//	 curpage => 1~5 일때동안 => startPage=1 유지 , endPage=5 유지
		//	 curpage => 6~10	=> startPage=6 유지 , endPage=10 유지 => 1,6,11
		// < [6][7][8][9][10] >
		// 화면
		/*
		 * 	<ul class="pagination">
		...
		out.println("<input type=submit value=검색 class=\"btn btn-sm btn-danger\">"); // 공백 따옴표
		out.println("</form>");
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
