...
public class BoardDAO {
	...
	//2. 싱글턴 => 싱글턴 사용 x 하면 => new 생성 => heap에서 계속 누적 => 오라클 연결되고 있다
	// 메모리 누수 , Connection 객체 생성개수를 제한
	// 한개의 메모리만 사용이 가능하게 만든다
	// 서버 프로그램, 데이터 베이스 프로그램에서 주로 사용
