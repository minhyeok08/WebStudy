...
public class BoardUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<td width=85%><input type=text name=name size=15 required></td>"); // required 입력값없으면 못넘어가게하는것
		out.println("</tr>");
		out.println("<tr>");
		...
		out.println("<td width=85%><textarea rows=10 cols=50 name=content required></textarea></td>"); //반드시 이름 부여 
																							//textarea는 열고 닫고 해야함
		out.println("</tr>");
		out.println("<tr>");
	...
	//http://localhost:8080/HTML_Project1/BoardInsertServlet?name=%ED%99%8D%EA%B8%B8%EB%8F%99&subject=%EC%B2%98%EC%9D%8C+%EB%A7%8C%EB%93%9C%EB%8A%94+%EA%B2%8C%EC%8B%9C%ED%8C%90&content=%EC%B2%98%EC%9D%8C+%EB%A7%8C%EB%93%9C%EB%8A%94+%EA%B2%8C%EC%8B%9C%ED%8C%90&pwd=1234
