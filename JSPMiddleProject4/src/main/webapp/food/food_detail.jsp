...
<%
	...
	/*
		addr1="서울특별시 종로구 북촌로 6-8"
		temp="종로구 북촌로 6-8"
		
		서울특별시 종로구 북촌로 6-8 지번 서울시 종로구 재동 85-1
	*/
%>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c6461032bfd9331ad3ba2ccc5ffbead2&libraries=services"></script>
</head>
<body>
	<div class="container">
		<div class="row">
