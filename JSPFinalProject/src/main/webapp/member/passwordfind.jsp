...
<script type="text/javascript">
	$(function(){
		...
		$('#emailBtn').click(function(){
			...
			// axios.get(params{name:name,email:email}), async axios.post() => vue,react => 서버연결 
			$.ajax({
				type:'post',
				url:'../member/passwordfindOk.do',
				data:{"name":name,"email":email}, // name=aaa&email.aaa
       ...
       <div id="tabs">
         ...
         <table class="table">
            ...
            <tr>
            	<td class="text-center" colspan="2">
            		<input type=button value="검색" class="input-sm" id="emailBtn" >
            	</td>
            </tr>
            <tr>
               <td class="text-center" colspan="2">
        ...
        <div id="tabs-2">
         <table class="table">
            ...
            <tr>
            	<td class="text-center" colspan="2">
            		<input type=button value="검색" class="input-sm" id="telBtn" >
            	</td>
            </tr>
            <tr>
               <td class="text-center" colspan="2">
