	  		...
	  		<td>
	  			<c:forEach var="rvo" items="${list }">
	  				<table class="table">
	  					...
	  					<tr>
	  						<td colspan="2"><pre style="white-space: pre-wrap;background-color: whire;border: none;">${rvo.msg }</pre></td>
	  					</tr>
	  					<tr style="display:none" class="reins" id="i${rvo.no }">
					  		<td colspan="2">
					  			<form method="post" action="../board/reply_reply_insert.do" class="inline">
									 ...
									 style="width:100px;height: 106px;background-color:green;color:white;">
					  			</form>
					  		</td>
		  				</tr>
